...
class WitRos(object):
    ...
    def start(self):
        ...
        rospy.Service('restaurant/wit/listen_interpret', ListenAndInterpret, self.listen_and_interpret)
    ...
    def listen_and_interpret(self, rosrequest):
        ...
        try:
            ...
            rospy.loginfo("Could not request results from Wit.ai service; {0}".format(e))
